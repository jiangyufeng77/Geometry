...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSizeW', type=int, default=286, help='scale images to this size (width)')
        parser.add_argument('--loadSizeH', type=int, default=286, help='scale images to this size (height)')
        parser.add_argument('--fineSizeW', type=int, default=256, help='then crop to this size (width)')
        parser.add_argument('--fineSizeH', type=int, default=256, help='then crop to this size (height)')
        ...
        parser.add_argument('--netD', type=str, default='attention', help='selects model to use for netD')
        parser.add_argument('--netG', type=str, default='attention', help='selects model to use for netG')
